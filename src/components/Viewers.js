...
const Container = styled.div`
  margin-top: 30px;
  padding: 30px 0 26px; //top: 30px, left-right: 0, bottom: 26px
  display: grid;
  grid-template-columns: repeat(5, minmax(0, 1fr));
  grid-gap: 25px; //rés az elemek között
...
const Wrap = styled.div`
  ...
  img {
    width: 100%;
    height: 100%;
    object-fit: cover; //a divet mennyire töltse ki a kép
    position: absolute;
    top: 0;
  }
  video {
  ...
  &:hover {
    ...
    transform: scale(1.05); //megnő kicsit
